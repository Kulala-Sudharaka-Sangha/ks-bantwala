        ...
        {showContact && (
          <div className="footer-contact">
            ...
            <div className="contact-details">
              <p>
                <strong>Toll Free Number:</strong> 18001033611
              </p>
              <p>
                <strong>Avvatar Care Email:</strong>{" "}
                <a href="mailto:CUSTOMERCARE@PARAG.COM">
                  CUSTOMERCARE@PARAG.COM
                </a>
              </p>
              <p>
                <strong>Email & Call Timings:</strong> Monday to Saturday (11:00
                AM – 6:00 PM)
              </p>
              <p>
                <strong>WhatsApp Messaging:</strong> Monday to Friday (9:30 AM –
                6:30 PM)
              </p>
              <p className="note">
